/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 4f9612a7ad8fd50aa7348df1c47b138a)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* my-next-app-worker */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_VARIABLE" | "NEXTJS_ENV">> {}
}
